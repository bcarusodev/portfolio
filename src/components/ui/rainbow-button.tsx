  ...
  return (
    <button
      ...
      className={cn(
        ...
        // light mode colors
        "bg-[linear-gradient(rgba(18,18,19,0.1),rgba(18,18,19,0.6)),linear-gradient(#121213_50%,rgba(18,18,19,0.6)_80%,rgba(18,18,19,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
        // dark mode colors
